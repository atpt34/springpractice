...
//        
        ...
        Coach newTennisCoach = context.getBean("newTennisCoach", Coach.class);
        System.out.println(newTennisCoach);
        System.out.println(newTennisCoach.getFortuneService());
        
        Coach newTennisCoach2 = context.getBean("newTennisCoach2", Coach.class);
        System.out.println(newTennisCoach2);
        System.out.println(newTennisCoach2.getFortuneService());
